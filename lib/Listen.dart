                  ...
                  child: new ListView(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text('Thanks for sharing! Kindly leave a rating', style: TextStyle(decoration: TextDecoration.none, color: Colors.white, fontSize: 18.0),),
                            Padding(
